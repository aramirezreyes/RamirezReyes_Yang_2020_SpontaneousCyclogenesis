...
function gather_diagnostic_3d_in_chunks(data_dir,exp_name,desired_var,chunk,chunksize,nchunks)
    ...
    for iter in 1:howmanyfiles
        ...
        file_name = string(exp_name,"_nosmoothing",filenumber+12,".jld")
...
"""
function get_composites_in_chunks(file2d,file3d,exp_name;offset_in_days = 0)
    ...
    composites_data_dir = "/global/cscratch1/sd/aramreye/for_postprocessing/CompositeOutputs_50d_9hpa_checkingInteraction/"
    azimuthal_averages_data_dir = "/global/cscratch1/sd/aramreye/for_postprocessing/AzimuthualAverageOutputs_50d_9hpa_checkingInteraction/"
